...
export default function Contact() {
  return (
    <section id="optagelse" style={{ padding: '100px 40px', background: 'var(--ink)' }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <ScrollReveal>
          <div style={{ display: 'grid', gap: '18px', padding: '28px', background: 'rgba(255,255,255,.06)', borderRadius: '24px', border: '1px solid rgba(255,255,255,.12)' }}>
            {['Psykologer', 'Psykoterapeuter med relevant grunduddannelse', 'Parterapeuter med dokumenteret terapeutisk uddannelse', 'Andre sundhedsprofessionelle efter individuel vurdering'].map((item) => (
        ...
        <ScrollReveal delay={100}>
          <div style={{ marginTop: '36px', display: 'grid', gap: '18px', padding: '28px', background: 'rgba(255,255,255,.06)', borderRadius: '24px', border: '1px solid rgba(255,255,255,.12)' }}>
            <p style={{ color: 'var(--paper)', fontSize: '17px', lineHeight: 1.9, margin: 0 }}>
              For at sikre et højt fagligt niveau vurderes ansøgernes uddannelsesmæssige baggrund ved optagelse.
            </p>
            <p style={{ color: 'var(--paper)', fontSize: '17px', lineHeight: 1.9, margin: 0 }}>
              Maks. 12 deltagere for at sikre aktiv deltagelse, refleksion og tæt kontakt til underviserne.
            </p>
          </div>
        </ScrollReveal>
      </div>
